...
fwrite(mpa3_sub75bp_species_decontam_filtered.alpha, "~/archgen/microbiome_calculus/smoking_calculus/05-results.backup/mpa3_alpha_div_numbers_sub75bp.tsv", sep = "\t", quote = F)
...
ggsave("./06-publication/supplemental_figures/SXX13/sub75bp_alpha_figure.pdf", plot = sub75bp_alpha_figure, device = "pdf",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX13/sub75bp_alpha_figure.png", plot = sub75bp_alpha_figure, device = "png",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)
