...
pc1pc2 <- plot_pca(mpa3_species_decontam_unfilt, "PC1", "PC2", "Site", "Time_period", 3)
pc1pc2
...
# ggplot(mpa3_all_pca_values, aes(PC1, PC2, color = Site, shape = Time_period)) +
#   geom_point(size = 2) +
...
mpa3_all_pca_values %>%
  bind_cols(., pc2_resid) %>%
ggplot(., aes(PC1, pc2_resid, colour = gc_avg, shape = Site, size = Site)) +
  geom_point() +
