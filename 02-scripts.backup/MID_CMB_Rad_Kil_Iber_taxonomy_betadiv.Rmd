...
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "extract_conc_ng/uL", "Pipenotch", 3, "DNA extract concentration (ng/uL)")
...
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "DNA_molecules_per_library_x10^6_log", "Pipenotch", 3, "log10(DNA_molecules_per_library_x10^6)")

# by % attributed to modern calculus by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "modernCalculus", "Pipenotch", 3, "% modern calculus")

# by % attributed to modern calculus by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "subPlaque", "Pipenotch", 3, "% subgingival plaque")

# by % attributed to unknown source by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Unknown", "Pipenotch", 3, "% Unknown source")
