...
plot_pca_mid <- function(df, pc1, pc2, color_group, shape_group, ncomps) {
    ...
    pca_plot <- ggplot(df_X, aes(pc1, pc2, colour = color_group, shape = shape_group)) +
                        geom_point(size = 2) +
                        scale_colour_manual(values = c("#5A167E","#C83E73","#E95562","#FEA873","#FED395","#252525","#311068")) +
...
# for continuous data
plot_pca_cont <- function(df, pc1, pc2, color_group, shape_group, ncomps) {
...
# perform and plot a PCA to see how the data cluster
# by Site
pca_village <- plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Site", "Time_period", 3)
pca_village
...
# by Age group
# plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Age", "Time_period", 3)
# plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Age", "Time_period", 3)
...
#   rownames_to_column("Library_ID")
#   
# malt_species_decontam_filtered_noblanks.pca.varmet <- inner_join(malt_species_decontam_filtered_noblanks.pca.variates, metadata, by = "Library_ID")
# 
...
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Description", "Description", "Description", 3)
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Description", "Description", "Description", 3)
...
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Tooth_site", "Ethnic_Group", 3)
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Tooth_site", "Ethnic_Group", 3)

# Now plot biplots, and make tables of the top 10 species in each loading
malt_species_decontam_filtered_biplot_121 <- plot_pca_bi(all_species_decontam_filtered_noblanks.pca, "PC1", "PC2", "Ethnic_Group", PC1)
...
malt_species_decontam_filtered_biplot_122 <- plot_pca_bi(all_species_decontam_filtered_noblanks.pca, "PC1", "PC2", "Ethnic_Group", PC2)
...
malt_species_decontam_filtered_biplot_322 <- plot_pca_bi(all_species_decontam_filtered_noblanks.pca, "PC3", "PC2", "Ethnic_Group", PC2)
malt_species_decontam_filtered_biplot_322

malt_species_decontam_filtered_biplot_323 <- plot_pca_bi(all_species_decontam_filtered_noblanks.pca, "PC3", "PC2", "Ethnic_Group", PC3)
...
# perform and plot a PCA to see how the data cluster
# by Village
pca_mid_pipenotch <- plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Pipenotch", "Periodontal_disease_present", 3)
pca_mid_pipenotch
plot_pca_mid(all_species_decontam_filtered_mid, "PC3", "PC2", "Pipenotch", "Periodontal_disease_present", 3)

# ggsave("05-results.backup/pca_mid_village.pdf", plot = pca_mid_village, device = "pdf",
#        scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# by presence of caries
plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Caries_present", "Pipenotch", 3)
plot_pca_mid(all_species_decontam_filtered_mid, "PC3", "PC2", "Caries_present", "Pipenotch", 3)

# by ante-mortem tooth loss
plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "AMTL", "Pipenotch", 3)
plot_pca_mid(all_species_decontam_filtered_mid, "PC3", "PC2", "AMTL", "Pipenotch", 3)

# by supragingival calculus score
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "calc_sup_SI_score", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "calc_sup_SI_score", "Pipenotch", 3)

# by subgingival calculus score
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Calc_sub_SI_score", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "Calc_sub_SI_score", "Pipenotch", 3)

# by presence of perioapical lesions
plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Periapical_lesions", "Pipenotch", 3)
plot_pca_mid(all_species_decontam_filtered_mid, "PC3", "PC2", "Periapical_lesions", "Pipenotch", 3)

# by max periodontal disease score
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Max_Perio_Score", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "Max_Perio_Score", "Pipenotch", 3)

# by periodontal affect score
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Peridontal_affect_score", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "Peridontal_affect_score", "Pipenotch", 3)

# by % antemortem tooth loss
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "%AMTL", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "%AMTL", "Pipenotch", 3)

# by % positions w/periapical lesions
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "%_positions_perioapical", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "%_positions_perioapical", "Pipenotch", 3)

# by % teeth with caries
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "%teeth_with_caries", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "%teeth_with_caries", "Pipenotch", 3)

# by % teeth with calculus
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "%teeth_with_calc", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "%teeth_with_calc", "Pipenotch", 3)

# by % positions with periodontal disease
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "%_positions_with_Periodontal", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "%_positions_with_Periodontal", "Pipenotch", 3)

# by minimum number of pipenotches 
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Min_no_Pipe_notches", "Pipenotch", 3)
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "Min_no_Pipe_notches", "Pipenotch", 3)
...
# 
# # Select out the PC variates into a new table and add the metadata for plotting
# all_species_decontam_filtered_mid.pca.variates <- as.data.frame(all_species_decontam_filtered_mid.pca$variates$X)
# all_species_decontam_filtered_mid.pca.variates <- all_species_decontam_filtered_mid.pca.variates %>%
#   rownames_to_column("Library_ID")
#   
# all_species_decontam_filtered_mid.pca.varmet <- inner_join(all_species_decontam_filtered_mid.pca.variates, metadata, by = "Library_ID")
# 
# pca_malt_species_pc1pc2 <- ggplot(all_species_decontam_filtered_mid.pca.varmet, aes(PC1, PC2, colour = Individual_Seq_Depth_NonHuman, shape = Ethnic_Group)) +
#   geom_point(size = 4) +
#   scale_shape_manual(values = Ethnic_Group_shapes) +
#   xlab(paste("PC1 - ", 100*(round(all_species_decontam_filtered_mid.pca$explained_variance[1], 2)), "%", sep = "")) +
#   ylab(paste("PC2 - ", 100*(round(all_species_decontam_filtered_mid.pca$explained_variance[2], 2))< "%", sep = "")) +
#   theme_minimal(base_size = 14) +
#   labs(colour = "Seq. depth\n(reads)", shape = "Ethnic group")
# 
# pca_malt_species_pc1pc2
...
all_species_decontam_filtered_nocontrols_biplot_122 <- plot_pca_bi(all_species_decontam_filtered_nocontrols.pca, "PC1", "PC2", "Tooth_site", PC2)
all_species_decontam_filtered_nocontrols_biplot_122
...
all_species_decontam_filtered_nocontrols_biplot_322 <- plot_pca_bi(all_species_decontam_filtered_nocontrols.pca, "PC3", "PC2", "Tooth_site", PC2)
all_species_decontam_filtered_nocontrols_biplot_322

all_species_decontam_filtered_nocontrols_biplot_323 <- plot_pca_bi(all_species_decontam_filtered_nocontrols.pca, "PC3", "PC2", "Tooth_site", PC3)
