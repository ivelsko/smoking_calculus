...
fwrite(full_table_sourcetracker, "./05-results.backup/shotgun_sourcetracker_table_noblanks.txt", sep = "\t", quote = F)
...
```{r}
st_table <- fread("./05-results.backup/shotgun_sourcetracker_table.txt")
