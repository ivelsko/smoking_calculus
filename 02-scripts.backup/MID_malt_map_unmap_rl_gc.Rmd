...
maltmappedGC_list <- list.files(path = "~/archgen/microbiome_calculus/smoking_calculus/04-analysis/gc_rl_sub_mapped/output/", pattern = "gc.tsv", full.names = T)
...
maluntmappedRL_list <- list.files(path = "~/archgen/microbiome_calculus/smoking_calculus/04-analysis/gc_rl_sub_mapped/output/", pattern = "readlength.tsv", full.names = T)
...
unmapped_rl_gc <- fread("~/archgen/microbiome_calculus/smoking_calculus/04-analysis/gc_rl_sub_mapped/output/FastQC/multiqc_data/multiqc_general_stats.txt") %>%
...
rl_gc_10M <- fread("~/archgen/microbiome_calculus/smoking_calculus/04-analysis/malt_checks/sub10M/gc_rl/FastQC/multiqc_data/multiqc_general_stats.txt") %>%
  select(Sample, `FastQC_mqc-generalstats-fastqc-percent_gc`,`FastQC_mqc-generalstats-fastqc-avg_sequence_length`) %>%
...
rl_gc_75bp <- fread("~/archgen/microbiome_calculus/smoking_calculus/04-analysis/malt_checks/sub75bp/gc_rl/FastQC/multiqc_data/multiqc_general_stats.txt") %>%
  select(Sample, `FastQC_mqc-generalstats-fastqc-percent_gc`,`FastQC_mqc-generalstats-fastqc-avg_sequence_length`) %>%
  separate(Sample, into = c("Sample","malt","Mapped"), extra = "merge", sep = "_") %>%
  select(-malt) %>%
