...
/projects1/microbiome_calculus/smoking_calculus/03-preprocessing/depth_check/sub10M/*.gz \
/projects1/microbiome_calculus/smoking_calculus/04-analysis/malt_checks/sub10M"
