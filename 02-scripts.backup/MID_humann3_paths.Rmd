...
humann3_pathway_biplot_list <- pca_EG_biplot_pc1$plot_env$pws_10 %>% select(-Function) %>% arrange(desc(PC1)) %>% select(pathway, PC1, PC2) %>% mutate(Direction = "PC1+")
humann3_pathway_biplot_list <- humann3_pathway_biplot_list %>%
  bind_rows(pca_EG_biplot_pc1$plot_env$neg_10 %>% select(-Function) %>% arrange(desc(PC1)) %>% select(pathway, PC1, PC2)%>% mutate(Direction = "PC1-"))
...
humann3_pathway_biplot_list <- humann3_pathway_biplot_list %>%
  bind_rows(pca_EG_biplot_pc2$plot_env$pws_10 %>% select(-Function) %>% arrange(desc(PC2)) %>% select(pathway, PC1, PC2) %>% mutate(Direction = "PC2+"))
humann3_pathway_biplot_list <- humann3_pathway_biplot_list %>%
  bind_rows(pca_EG_biplot_pc2$plot_env$neg_10 %>% select(-Function) %>% arrange(desc(PC2)) %>% select(pathway, PC1, PC2) %>% mutate(Direction = "PC2-"))
