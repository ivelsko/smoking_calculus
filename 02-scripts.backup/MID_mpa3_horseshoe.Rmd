...
exb_batches <- ggplot(malt_pca_values, aes(PC1, PC2, color = Extraction_batch, shape = Region)) +
  geom_point(size = 2) +
  theme_minimal()
...
lib_batches <- ggplot(malt_pca_values, aes(PC1, PC2, color = Library_batch, shape = Region)) +
  geom_point(size = 2) +
  theme_minimal()
