...
```{r}
mpa3_contaminants <- fread("./05-results.backup/contaminant_species_radcliffe_mpa3_sub10M.tsv", sep = "\t") %>%
...
ggsave("./06-publication/supplemental_figures/SXX12/sub10M_alpha_figure.pdf", plot = sub10M_alpha_figure, device = "pdf",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX12/sub10M_alpha_figure.png", plot = sub10M_alpha_figure, device = "png",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)
