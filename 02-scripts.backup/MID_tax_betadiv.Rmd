...
# perform and plot a PCA to see how the data cluster
plot_pca(all_species_decontam_filtered, "PC1", "PC2", "Site", "Time_period", 3)

plot_pca(all_species_decontam_filtered, "PC3", "PC2", "Site", "Time_period", 3)
...
plot_pca(all_species_decontam_filtered_noblanks, "PC2", "PC3", "Site", "Time_period", 3)
...
all_tooth_pc12 <- plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Tooth_location", "Time_period", 3)
all_tooth_pc12
