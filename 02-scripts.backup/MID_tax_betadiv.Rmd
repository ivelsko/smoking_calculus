...
full_metadata <- full_metadata %>%
  ...
  mutate(pct_human_reads = (No_reads_total - No_reads_no_human)/ No_reads_total *100,
         pct_human_reads_log = log10(pct_human_reads))
...
check_sp <- all_species_raw %>%
  # select(matches("Species|MID|CMB")) %>%
  filter(str_detect(Species, "Neisseria")) %>%
  gather("Sample_ID","Counts", 2:ncol(.)) %>%
...
strep_group_info <- all_species_decontam_prev %>%
...
plot_pca <- function(df, pc1, pc2, color_group, shape_group, ncomps, title_text) {
...
```{r pca_all_species}
# decontaminated only
all_species_decontam_unfilt <- all_species_raw %>%
  ...
  spread(Species,Counts) %>%
  filter(Library_ID != "JAE011.A0101") %>%
...
plot_pca(all_species_decontam_unfilt, "PC1", "PC2", "Site_code", "Time_period", 3, "All raw")
plot_pca(all_species_decontam_unfilt, "PC3", "PC2", "Site_code", "Time_period", 3, "All raw")

# decontaminated and filtered
all_species_decontam_filtered <- all_species_decontam_prev %>%
...
# perform and plot a PCA to see how the data cluster
plot_pca(all_species_decontam_filtered, "PC1", "PC2", "Site_code", "Time_period", 3, "Decontam prev 0.005%")

plot_pca(all_species_decontam_filtered, "PC3", "PC2", "Site_code", "Time_period", 3, "Decontam prev 0.005%")
...
all_species_decontam_noblanks_presence_more_10 <- all_species_decontam_prev %>%
...
# Species, no blanks 
all_species_decontam_noblanks <- all_species_decontam_prev %>%
  select(-matches("EXB|LIB|CSS|CSD|CSN|CSL")) %>%
  select(-one_of(outliers)) %>%
  select(-one_of(poor_samples)) %>%
...
# perform PCA
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Region", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC3", "PC2", "Region", "Time_period", 3, "Decontam prev ")

plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Site_code", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Time_period", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Sex", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Periodontal_disease_present", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Caries_present", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "Tooth_location", "Time_period", 3, "Decontam prev ")
plot_pca(all_species_decontam_noblanks, "PC1", "PC2", "alt_tooth_location", "Time_period", 3, "Decontam prev ")
plot_pca_cont(all_species_decontam_noblanks, "PC1", "PC2", "pct_human_reads_log", "Time_period", 3, "Decontam prev ")
...
all_species_decontam_filtered_noblanks <- all_species_decontam_prev %>%
  select(-matches("EXB|LIB|CSS|CSD|CSN|CSL|JAE|VLC")) %>%
  select(-one_of(outliers)) %>%
  select(-one_of(poor_samples)) %>%
...
# perform and plot a PCA to see how the data cluster
# by Site
mid_all_pc12 <- plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Site_code", "Time_period", 3, "Decontam prev")
mid_all_pc12
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC3", "Site_code", "Time_period", 3, "Decontam freq")
plot_pca(all_species_decontam_filtered_noblanks, "PC2", "PC3", "Site_code", "Time_period", 3, "Decontam freq")

mid_all_pc32 <- plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Site_code", "Time_period", 3, "Decontam prev")
mid_all_pc32
...
```{r}
# by Region
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Region", "Time_period", 3, "Decontam prev")

# by Time period
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Time_period", "Time_period", 3, "Decontam prev")
# by Sex
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Sex", "Time_period", 3, "Decontam prev")

# by periodontal diseae (anywhere in the mouth)
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Periodontal_disease_present", "Time_period", 3, "Decontam prev")

# by caries (anywhere in the mouth)
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Caries_present", "Time_period", 3, "Decontam prev")

# by sampled tooth/teeth location
all_tooth_pc12 <- plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Tooth_location", "Time_period", 3, "Decontam prev")
all_tooth_pc12
# ggsave("~/Desktop/MID_pca_all_tooth_pc12.pdf", plot = all_tooth_pc12, device = "pdf",
#        scale = 1, width = 8, height = 5, units = c("in"), dpi = 300)

# by sampled tooth/teeth location
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "alt_tooth_location", "Time_period", 3, "Decontam prev")
...
# by sourceTracker results % modernCalculus
all_modcalc_pc12 <- malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC1, PC2, colour = modernCalculus, shape = Time_period)) +
    geom_point(size = 3) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC1 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[1], 2)), "%", sep = "")) +
    ylab(paste("PC2 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[2], 2)), "%", sep = "")) +
    theme_minimal(base_size = 14) +
    labs(colour = "% modernCalculus", shape = "Time period") +
    theme(legend.title = element_text(size = 10)) +
    ggtitle("Decontam prev")
all_modcalc_pc12
# ggsave("~/Desktop/MID_pca_all_modcalc_pc12.pdf", plot = all_modcalc_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by sourceTracker results % subgingival Plaque
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC1, PC2, colour = subPlaque, shape = Time_period)) +
    geom_point(size = 3) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC1 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[1], 2)), "%", sep = "")) +
    ylab(paste("PC2 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[2], 2)), "%", sep = "")) +
    theme_minimal(base_size = 14) +
    labs(colour = "% subgingival plaque", shape = "Time period") +
    theme(legend.title = element_text(size = 10)) +
    ggtitle("Decontam prev")


# by sourceTracker results % unknown
all_unknown_pc12 <- malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC1, PC2, colour = Unknown, shape = Time_period)) +
    geom_point(size = 3) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC1 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[1], 2)), "%", sep = "")) +
    ylab(paste("PC2 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[2], 2)), "%", sep = "")) +
    theme_minimal(base_size = 14) +
    labs(colour = "% Unknown", shape = "Time period") +
    theme(legend.title = element_text(size = 10)) +
    ggtitle("Decontam prev")
all_unknown_pc12
# ggsave("~/Desktop/MID_pca_all_unknown_pc12.pdf", plot = all_unknown_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)
...
plot_pca_cont(all_species_decontam_filtered_noblanks, "PC1", "PC2", "pct_human_reads_log", "Time_period", 3, "Decontam prev ")
...
# by Site
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Site_code", "Time_period", 3, "Decontam freq")
# by Region
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Region", "Time_period", 3, "Decontam freq")

# by Time period
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Time_period", "Time_period", 3, "Decontam freq")

# by Sex
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Sex", "Time_period", 3, "Decontam freq")

# by periodontal diseae (anywhere in the mouth)
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Periodontal_disease_present", "Time_period", 3, "Decontam freq")

# by caries (anywhere in the mouth)
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Caries_present", "Time_period", 3, "Decontam freq")

# by sampled tooth/teeth location
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Tooth_location", "Time_period", 3, "Decontam freq")

# by sampled tooth/teeth location
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "alt_tooth_location", "Time_period", 3, "Decontam freq")
...
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC3, PC2, colour = modernCalculus, shape = Time_period)) +
    geom_point(size = 2) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC3 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[3], 2)), "%", sep = "")) +
...
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC3, PC2, colour = subPlaque, shape = Time_period)) +
    geom_point(size = 2) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC3 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[3], 2)), "%", sep = "")) +
...
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  full_join(., full_source_results %>%
              rename(Library_ID = SampleID)) %>%
  ggplot(., aes(PC3, PC2, colour = Unknown, shape = Time_period)) +
    geom_point(size = 2) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC3 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[3], 2)), "%", sep = "")) +
...
# by average GC content
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  ggplot(., aes(PC3, PC2, colour = gc_avg, shape = Time_period)) +
    geom_point(size = 2.5) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC3 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[3], 2)), "%", sep = "")) +
...
# by average read length
malt_species_decontam_filtered_noblanks.pca.varmet %>%
  ggplot(., aes(PC3, PC2, colour = seq_len_avg, shape = Time_period)) +
    geom_point(size = 2.5) +
    scale_shape_manual(values = Time_period_shapes) +
    scale_color_viridis_c(option = "A") +
    xlab(paste("PC3 - ", 100*(round(malt_species_decontam_filtered_noblanks.pca$prop_expl_var$X[3], 2)), "%", sep = "")) +
...
plot_pca_cont(all_species_decontam_filtered_noblanks, "PC3", "PC2", "pct_human_reads_log", "Time_period", 3, "Decontam prev ")
...
plot_pca(all_species_decontam_filtered_noblanks, "PC1", "PC2", "Region", "Time_period", 3, "Decontam freq")
plot_pca(all_species_decontam_filtered_noblanks, "PC3", "PC2", "Region", "Time_period", 3, "Decontam freq")
...
all_species_decontam_filtered_mid <- all_species_decontam_prev %>%
  select(-one_of(outliers)) %>%
  select(-one_of(poor_samples)) %>%
...
# prepare to run a PCA
# check the number of components to retain by tuning the PCA
mixOmics::tune.pca(all_species_decontam_filtered_mid, logratio = 'CLR')


malt_otu.pca <- mixOmics::pca(all_species_decontam_filtered_mid, ncomp = 2, logratio = 'CLR')
...
mid_pipe_pc12 <- plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Pipenotch", "Pipenotch", 3, "Pipe notch")
mid_pipe_pc12
...
mid_minpipe_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Min_no_Pipe_notches", "Pipenotch", 3, "Min # pipe notches")
mid_minpipe_pc12
# ggsave("~/Desktop/MID_pca_mid_minpipe_pc12.pdf", plot = mid_minpipe_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by sequencing depth 
mid_seqdepth_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "No_reads_total", "Pipenotch", 3, "Total reads into MALT")
mid_seqdepth_pc12
# ggsave("~/Desktop/MID_pca_mid_seqdepth_pc12.pdf", plot = mid_seqdepth_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by sampled tooth site(s)
mid_tooth_pc12 <- plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Tooth_location", "Pipenotch", 3, "Tooth location")
mid_tooth_pc12
...
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "extract_conc_ng/mg", "Pipenotch", 3, "DNA extract concentration (ng/mg)")

# by [DNA] after extraction per uL of eluate
mid_extract_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "extract_conc_ng/uL", "Pipenotch", 3, "DNA extract concentration (ng/uL)")
mid_extract_pc12
...
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "extract_conc_after_storage_ng/mg", "Pipenotch", 3, "DNA extract concentration after storage (ng/uL)")

# by # of molecules in the library after indexing amplification
mid_library_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "DNA_molecules_per_library_x10^6_log", "Pipenotch", 3, "log10(DNA_molecules_per_library_x10^6)")
mid_library_pc12
# ggsave("~/Desktop/MID_pca_mid_library_pc12.pdf", plot = mid_library_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by % attributed to modern calculus by sourcetracker
mid_modalc_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "modernCalculus", "Pipenotch", 3, "% modern calculus")
mid_modalc_pc12
# ggsave("~/Desktop/MID_pca_mid_modcalc_pc12.pdf", plot = mid_modalc_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by % attributed to subgingical plaque by sourcetracker
mid_plaque_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "subPlaque", "Pipenotch", 3, "% subgingival plaque")
mid_plaque_pc12
# ggsave("~/Desktop/MID_pca_mid_subplaque_pc12.pdf", plot = mid_plaque_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by % attributed to unknown source by sourcetracker
mid_unknown_pc12 <- plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "Unknown", "Pipenotch", 3, "% Unknown source")
mid_unknown_pc12
# ggsave("~/Desktop/MID_pca_mid_unknown_pc12.pdf", plot = mid_unknown_pc12, device = "pdf",
#        scale = 1, width = 9, height = 5, units = c("in"), dpi = 300)

# by soil type
plot_pca_mid(all_species_decontam_filtered_mid, "PC1", "PC2", "Soil", "Pipenotch", 3, "Soil type")

# by average GC content
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "gc_avg", "Time_period", 3, "Avg. GC content (%)")

# by average read length
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "seq_len_avg", "Time_period", 3, "Avg. read length (bp)")

# by % human reads
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "pct_human_reads_log", "Site_code", 3, "Avg. read length (bp)")

# by proportion of Sanguinis group
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "sanguinis", "Site_code", 3, "Proportion of Sanguins group")

# by proportion of Sanguinis group
plot_pca_cont(all_species_decontam_filtered_mid, "PC1", "PC2", "anginosus", "Site_code", 3, "Proportion of Anginosus group")
...
# sample_order %>%
#   as_data_frame(.) %>%
#   rename(Library_ID = value) %>%
#   full_join(., malt_pca_values %>%
#             inner_join(., full_metadata, by = "Library_ID") %>%
#             select(Library_ID))
#   
# malt_pca_values %>%
...
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "extract_conc_ng/mg", "Pipenotch", 3, "DNA extract concentration (ng/mg)")

# by [DNA] after extraction per uL of eluate
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "extract_conc_ng/uL", "Pipenotch", 3, "DNA extract concentration (ng/uL)")

# by [DNA] after storage, before building libraries
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "extract_conc_after_storage_ng/mg", "Pipenotch", 3, "DNA extract concentration after storage (ng/uL)")

# by # of molecules in the library after indexing amplification
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "DNA_molecules_per_library_x10^6_log", "Pipenotch", 3, "log10(DNA_molecules_per_library_x10^6)")

# by % attributed to modern calculus by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "modernCalculus", "Pipenotch", 3, "% modern calculus")

# by % attributed to subgingival plaque by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "subPlaque", "Pipenotch", 3, "% subgingival plaque")

# by % attributed to unknown source by sourcetracker
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "Unknown", "Pipenotch", 3, "% Unknown source")

# by soil type
plot_pca_mid(all_species_decontam_filtered_mid, "PC3", "PC2", "Soil", "Pipenotch", 3, "Soil type")

# by average GC content
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "gc_avg", "Time_period", 33, "Avg. GC content (%)")

# by average read length
plot_pca_cont(all_species_decontam_filtered_mid, "PC3", "PC2", "seq_len_avg", "Time_period", 33, "Avg. read length (bp)")
