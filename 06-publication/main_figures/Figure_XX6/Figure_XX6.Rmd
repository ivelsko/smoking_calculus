...
da_fig
ggsave("./06-publication/main_figures/Figure_XX6/DA_strep_dist.pdf", plot = da_fig,
       device = "pdf", scale = 1, width = 12, height = 8.5, units = c("in"), dpi = 300)

ggsave("./06-publication/main_figures/Figure_XX6/DA_strep_dist.png", plot = da_fig,
