...
smpd <- full_metadata %>%
  ...
  ggplot(., aes(x = Pipenotch, y = Age, fill = Peridontal_affect_score, shape = Sex, size = `%AMTL`)) +
    ggpointgrid::geom_pointrect(scale_x = 0.10, scale_y = 0.22, color = "black", stroke = 1.1) +
...
ggsave("./06-publication/supplemental_figures/XX1/smpd.pdf", plot = smpd, device = "pdf",
...
ggsave("./06-publication/supplemental_figures/XX1/smc.pdf", plot = smc, device = "pdf",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/XX1/smcs.pdf", plot = smcs, device = "pdf",
       scale = 1, width = 10, height = 7, units = c("in"), dpi = 300)
